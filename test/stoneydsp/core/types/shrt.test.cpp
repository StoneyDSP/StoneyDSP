...
STONEYDSP_TEST_CASE ("[core][types][shrt_t][requirements]",
                     "[core][types][shrt_t][requirements]")
{
  STONEYDSP_SECTION ("[core][types][shrt_t][requirements][min]")
  {
    bool result = false;
  #if defined(SHRT_MIN)
    result = true;
  ...
  STONEYDSP_SECTION ("[core][types][shrt_t][requirements][max]")
  {
    bool result = false;
  #if defined(SHRT_MAX)
    result = true;
...
STONEYDSP_TEST_CASE ("[core][types][shrt_t][numeric_limits]",
                     "[core][types][shrt_t][numeric_limits]")
{
  // { -32768 }
  STONEYDSP_REQUIRE (::stoneydsp::numeric_limits< ::stoneydsp::shrt_t>::min ()
                     == ::std::numeric_limits< ::stoneydsp::shrt_t>::min ());
  // { 32767 }
  STONEYDSP_REQUIRE (::stoneydsp::numeric_limits< ::stoneydsp::shrt_t>::max ()
                     == ::std::numeric_limits< ::stoneydsp::shrt_t>::max ());
  // { -32768 }
  STONEYDSP_REQUIRE (
      ::stoneydsp::numeric_limits< ::stoneydsp::shrt_t>::lowest ()
      == ::std::numeric_limits< ::stoneydsp::shrt_t>::lowest ());
}

//==============================================================//special_values

STONEYDSP_TEST_CASE ("[core][types][shrt_t][special_values]",
                     "[core][types][shrt_t][special_values]")
{
  ::stoneydsp::shrt_t min_val
      = ::std::numeric_limits< ::stoneydsp::shrt_t>::min ();
  ::stoneydsp::shrt_t max_val
      = ::std::numeric_limits< ::stoneydsp::shrt_t>::max ();
  STONEYDSP_REQUIRE (min_val == -32768); // Minimum value for shrt_t
  STONEYDSP_REQUIRE (max_val == 32767);  // Maximum value for shrt_t
}

//==================================================================//endianness

STONEYDSP_TEST_CASE ("[core][types][shrt_t][endianness]",
...
STONEYDSP_TEST_CASE ("[core][types][shrt_t][arithmetic]",
...
STONEYDSP_TEST_CASE ("[core][types][shrt_t][bitwise][logic]",
                     "[core][types][shrt_t][bitwise][logic]")
{
  using namespace ::stoneydsp::core::types::literals;
  ...
  STONEYDSP_REQUIRE (~a == -6);     // NOT: considering wrap-around for shrt_t
}

STONEYDSP_TEST_CASE ("[core][types][shrt_t][bitwise][arithmetic]",
                     "[core][types][shrt_t][bitwise][arithmetic]")
{
  using namespace ::stoneydsp::core::types::literals;
...
STONEYDSP_TEST_CASE ("[core][types][shrt_t][comparison]",
...
STONEYDSP_TEST_CASE ("[core][types][shrt_t][serialization]",
...
STONEYDSP_TEST_CASE ("[core][types][shrt_t][boundary][overflow]",
                     "[core][types][shrt_t][boundary][overflow]")
{
  ...
  STONEYDSP_REQUIRE (static_cast< ::stoneydsp::shrt_t> (a + b)
                     == -32768); // Check overflow wrap-around behaviour
}

//======================================================//boundary_and_underflow

STONEYDSP_TEST_CASE ("[core][types][shrt_t][boundary][underflow]",
...
STONEYDSP_TEST_CASE ("[core][types][shrt_t][compatibility]",
...
STONEYDSP_TEST_CASE ("[core][types][shrt_t][benchmark][addition]",
                     "[core][types][shrt_t][benchmark][addition]")
{
  using namespace ::stoneydsp::core::types::literals;
...
STONEYDSP_TEST_CASE ("[core][types][shrt_t][benchmark][subtraction]",
                     "[core][types][shrt_t][benchmark][subtraction]")
{
  using namespace ::stoneydsp::core::types::literals;
...
STONEYDSP_TEST_CASE ("[core][types][shrt_t][benchmark][multiplication]",
                     "[core][types][shrt_t][benchmark][multiplication]")
{
  using namespace ::stoneydsp::core::types::literals;
...
STONEYDSP_TEST_CASE ("[core][types][shrt_t][benchmark][division]",
                     "[core][types][shrt_t][benchmark][division]")
{
  using namespace ::stoneydsp::core::types::literals;
...
STONEYDSP_TEST_CASE ("[core][types][shrt_t][benchmark][conversion][float]",
                     "[core][types][shrt_t][benchmark][conversion][float]")
{
  using namespace ::stoneydsp::core::types::literals;
