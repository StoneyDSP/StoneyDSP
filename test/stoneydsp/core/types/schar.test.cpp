...
STONEYDSP_TEST_CASE ("[core][types][schar_t][requirements]",
                     "[core][types][schar_t][requirements]")
{
  STONEYDSP_SECTION ("[core][types][schar_t][requirements][min]")
  {
    bool result = false;
  ...
  STONEYDSP_SECTION ("[core][types][schar_t][requirements][max]")
  {
    bool result = false;
