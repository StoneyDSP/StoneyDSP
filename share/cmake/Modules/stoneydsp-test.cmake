...
cmake_dependent_option(STONEYDSP_TEST_CATCH2_SESSION_TARGET_INSTALL "Notes" OFF "STONEYDSP_BUILD_TEST" ON)
cmake_dependent_option(STONEYDSP_TEST_CATCH2_SESSION_TARGET_EXPORT "Notes" OFF "STONEYDSP_BUILD_TEST" ON)
...
function(stoneydsp_add_test)
    ...
    if(STONEYDSP_BUILD_CORE)
        set(STONEYDSP_CORE_TEST_CPP_FILE "${STONEYDSP_TEST_DIR}/${STONEYDSP_SLUG}/${STONEYDSP_CORE_TARGET_NAME}/${STONEYDSP_CORE_TARGET_NAME}.test.cpp")
        set(STONEYDSP_CORE_SYSTEM_PLATFORM_TEST_CPP_FILE "${STONEYDSP_TEST_DIR}/${STONEYDSP_SLUG}/${STONEYDSP_CORE_TARGET_NAME}/system/platform.test.cpp")
        set(STONEYDSP_CORE_SYSTEM_COMPILER_TEST_CPP_FILE "${STONEYDSP_TEST_DIR}/${STONEYDSP_SLUG}/${STONEYDSP_CORE_TARGET_NAME}/system/compiler.test.cpp")
        set(STONEYDSP_CORE_MATHS_TEST_CPP_FILE "${STONEYDSP_TEST_DIR}/${STONEYDSP_SLUG}/${STONEYDSP_CORE_TARGET_NAME}/maths/maths.test.cpp")
        set(STONEYDSP_CORE_TYPES_CHAR_TEST_CPP_FILE "${STONEYDSP_TEST_DIR}/${STONEYDSP_SLUG}/${STONEYDSP_CORE_TARGET_NAME}/types/char.test.cpp")
        set(STONEYDSP_CORE_TYPES_SCHAR_TEST_CPP_FILE "${STONEYDSP_TEST_DIR}/${STONEYDSP_SLUG}/${STONEYDSP_CORE_TARGET_NAME}/types/schar.test.cpp")
        set(STONEYDSP_CORE_TYPES_UCHAR_TEST_CPP_FILE "${STONEYDSP_TEST_DIR}/${STONEYDSP_SLUG}/${STONEYDSP_CORE_TARGET_NAME}/types/uchar.test.cpp")
        set(STONEYDSP_CORE_TYPES_SHRT_TEST_CPP_FILE "${STONEYDSP_TEST_DIR}/${STONEYDSP_SLUG}/${STONEYDSP_CORE_TARGET_NAME}/types/shrt.test.cpp")
        set(STONEYDSP_CORE_TYPES_USHRT_TEST_CPP_FILE "${STONEYDSP_TEST_DIR}/${STONEYDSP_SLUG}/${STONEYDSP_CORE_TARGET_NAME}/types/ushrt.test.cpp")
        ...
        set(STONEYDSP_CORE_TYPES_UINT_TEST_CPP_FILE "${STONEYDSP_TEST_DIR}/${STONEYDSP_SLUG}/${STONEYDSP_CORE_TARGET_NAME}/types/uint.test.cpp")
        set(STONEYDSP_CORE_TYPES_LONG_TEST_CPP_FILE "${STONEYDSP_TEST_DIR}/${STONEYDSP_SLUG}/${STONEYDSP_CORE_TARGET_NAME}/types/long.test.cpp")
        set(STONEYDSP_CORE_TYPES_ULONG_TEST_CPP_FILE "${STONEYDSP_TEST_DIR}/${STONEYDSP_SLUG}/${STONEYDSP_CORE_TARGET_NAME}/types/ulong.test.cpp")
        set(STONEYDSP_CORE_TYPES_LLONG_TEST_CPP_FILE "${STONEYDSP_TEST_DIR}/${STONEYDSP_SLUG}/${STONEYDSP_CORE_TARGET_NAME}/types/llong.test.cpp")
        set(STONEYDSP_CORE_TYPES_ULLONG_TEST_CPP_FILE "${STONEYDSP_TEST_DIR}/${STONEYDSP_SLUG}/${STONEYDSP_CORE_TARGET_NAME}/types/ullong.test.cpp")
        set(STONEYDSP_CORE_TYPES_INT8_TEST_CPP_FILE "${STONEYDSP_TEST_DIR}/${STONEYDSP_SLUG}/${STONEYDSP_CORE_TARGET_NAME}/types/int8.test.cpp")
        set(STONEYDSP_CORE_TYPES_INT16_TEST_CPP_FILE "${STONEYDSP_TEST_DIR}/${STONEYDSP_SLUG}/${STONEYDSP_CORE_TARGET_NAME}/types/int16.test.cpp")
        set(STONEYDSP_CORE_TYPES_INT32_TEST_CPP_FILE "${STONEYDSP_TEST_DIR}/${STONEYDSP_SLUG}/${STONEYDSP_CORE_TARGET_NAME}/types/int32.test.cpp")
        set(STONEYDSP_CORE_TYPES_INT64_TEST_CPP_FILE "${STONEYDSP_TEST_DIR}/${STONEYDSP_SLUG}/${STONEYDSP_CORE_TARGET_NAME}/types/int64.test.cpp")
        set(STONEYDSP_CORE_TYPES_UINT8_TEST_CPP_FILE "${STONEYDSP_TEST_DIR}/${STONEYDSP_SLUG}/${STONEYDSP_CORE_TARGET_NAME}/types/uint8.test.cpp")
        set(STONEYDSP_CORE_TYPES_UINT16_TEST_CPP_FILE "${STONEYDSP_TEST_DIR}/${STONEYDSP_SLUG}/${STONEYDSP_CORE_TARGET_NAME}/types/uint16.test.cpp")
        set(STONEYDSP_CORE_TYPES_UINT32_TEST_CPP_FILE "${STONEYDSP_TEST_DIR}/${STONEYDSP_SLUG}/${STONEYDSP_CORE_TARGET_NAME}/types/uint32.test.cpp")
        set(STONEYDSP_CORE_TYPES_UINT64_TEST_CPP_FILE "${STONEYDSP_TEST_DIR}/${STONEYDSP_SLUG}/${STONEYDSP_CORE_TARGET_NAME}/types/uint64.test.cpp")
        set(STONEYDSP_CORE_TYPES_DBL_TEST_CPP_FILE "${STONEYDSP_TEST_DIR}/${STONEYDSP_SLUG}/${STONEYDSP_CORE_TARGET_NAME}/types/double.test.cpp")
        set(STONEYDSP_CORE_TYPES_FLT_TEST_CPP_FILE "${STONEYDSP_TEST_DIR}/${STONEYDSP_SLUG}/${STONEYDSP_CORE_TARGET_NAME}/types/float.test.cpp")
        set(STONEYDSP_CORE_TYPES_SIZE_TEST_CPP_FILE "${STONEYDSP_TEST_DIR}/${STONEYDSP_SLUG}/${STONEYDSP_CORE_TARGET_NAME}/types/size.test.cpp")
        set(STONEYDSP_CORE_TYPES_PTRDIFF_TEST_CPP_FILE "${STONEYDSP_TEST_DIR}/${STONEYDSP_SLUG}/${STONEYDSP_CORE_TARGET_NAME}/types/ptrdiff.test.cpp")

        # set(STONEYDSP_CORE_TYPES_NULLPTR_TEST_CPP_FILE "${STONEYDSP_TEST_DIR}/${STONEYDSP_SLUG}/${STONEYDSP_CORE_TARGET_NAME}/types/nullptr.test.cpp")
        # set(STONEYDSP_CORE_TYPES_MAX_ALIGN_TEST_CPP_FILE "${STONEYDSP_TEST_DIR}/${STONEYDSP_SLUG}/${STONEYDSP_CORE_TARGET_NAME}/types/max_align.test.cpp")
        list(APPEND STONEYDSP_TEST_SOURCE_FILES
            "${STONEYDSP_CORE_TEST_CPP_FILE}"
            "${STONEYDSP_CORE_SYSTEM_PLATFORM_TEST_CPP_FILE}"
            "${STONEYDSP_CORE_SYSTEM_COMPILER_TEST_CPP_FILE}"
            "${STONEYDSP_CORE_MATHS_TEST_CPP_FILE}"
            "${STONEYDSP_CORE_TYPES_CHAR_TEST_CPP_FILE}"
            "${STONEYDSP_CORE_TYPES_SCHAR_TEST_CPP_FILE}"
            "${STONEYDSP_CORE_TYPES_UCHAR_TEST_CPP_FILE}"
            "${STONEYDSP_CORE_TYPES_SHRT_TEST_CPP_FILE}"
            "${STONEYDSP_CORE_TYPES_USHRT_TEST_CPP_FILE}"
            "${STONEYDSP_CORE_TYPES_INT_TEST_CPP_FILE}"
            "${STONEYDSP_CORE_TYPES_UINT_TEST_CPP_FILE}"
            "${STONEYDSP_CORE_TYPES_LONG_TEST_CPP_FILE}"
            "${STONEYDSP_CORE_TYPES_ULONG_TEST_CPP_FILE}"
            "${STONEYDSP_CORE_TYPES_LLONG_TEST_CPP_FILE}"
            "${STONEYDSP_CORE_TYPES_ULLONG_TEST_CPP_FILE}"
            "${STONEYDSP_CORE_TYPES_INT8_TEST_CPP_FILE}"
            "${STONEYDSP_CORE_TYPES_INT16_TEST_CPP_FILE}"
            "${STONEYDSP_CORE_TYPES_INT32_TEST_CPP_FILE}"
            "${STONEYDSP_CORE_TYPES_INT64_TEST_CPP_FILE}"
            "${STONEYDSP_CORE_TYPES_UINT8_TEST_CPP_FILE}"
            "${STONEYDSP_CORE_TYPES_UINT16_TEST_CPP_FILE}"
            "${STONEYDSP_CORE_TYPES_UINT32_TEST_CPP_FILE}"
            "${STONEYDSP_CORE_TYPES_UINT64_TEST_CPP_FILE}"
            "${STONEYDSP_CORE_TYPES_DBL_TEST_CPP_FILE}"
            "${STONEYDSP_CORE_TYPES_FLT_TEST_CPP_FILE}"
            "${STONEYDSP_CORE_TYPES_SIZE_TEST_CPP_FILE}"
            "${STONEYDSP_CORE_TYPES_PTRDIFF_TEST_CPP_FILE}"

            # "${STONEYDSP_CORE_TYPES_NULLPTR_T_TEST_CPP_FILE}"
            # "${STONEYDSP_CORE_TYPES_MAX_ALIGN_T_TEST_CPP_FILE}"
        )
    endif(STONEYDSP_BUILD_CORE)

    if(STONEYDSP_BUILD_SIMD)
        set(STONEYDSP_SIMD_VECTOR_FLOAT4_TEST_CPP_FILE "${STONEYDSP_TEST_DIR}/${STONEYDSP_SLUG}/${STONEYDSP_SIMD_TARGET_NAME}/vector/float4.test.cpp")
        list(APPEND STONEYDSP_TEST_SOURCE_FILES

            # "${STONEYDSP_SIMD_VECTOR_FLOAT4_TEST_CPP_FILE}"
        )
    endif(STONEYDSP_BUILD_SIMD)

    if(STONEYDSP_BUILD_DSP)
        set(STONEYDSP_DSP_TEST_CPP_FILE "${STONEYDSP_TEST_DIR}/${STONEYDSP_SLUG}/${STONEYDSP_DSP_TARGET_NAME}/${STONEYDSP_DSP_TARGET_NAME}.test.cpp")
        set(STONEYDSP_DSP_FILTERS_BIQUAD_TEST_CPP_FILE "${STONEYDSP_TEST_DIR}/${STONEYDSP_SLUG}/${STONEYDSP_DSP_TARGET_NAME}/filters/biquad.test.cpp")
        set(STONEYDSP_DSP_FILTERS_MATCHED_BIQUAD_COEFFICIENTS_TEST_CPP_FILE "${STONEYDSP_TEST_DIR}/${STONEYDSP_SLUG}/${STONEYDSP_DSP_TARGET_NAME}/filters/matched_biquad_coefficients.test.cpp")
        list(APPEND STONEYDSP_TEST_SOURCE_FILES
            "${STONEYDSP_DSP_TEST_CPP_FILE}"
            "${STONEYDSP_DSP_FILTERS_BIQUAD_TEST_CPP_FILE}"
            "${STONEYDSP_DSP_FILTERS_MATCHED_BIQUAD_COEFFICIENTS_TEST_CPP_FILE}"
        )
    endif(STONEYDSP_BUILD_DSP)
