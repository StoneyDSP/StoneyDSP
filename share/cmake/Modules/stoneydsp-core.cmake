...
function(stoneydsp_add_core)
    ...
    set(STONEYDSP_CORE_TYPES_CHAR_H_FILE "${STONEYDSP_INCLUDE_DIR}/${STONEYDSP_SLUG}/${STONEYDSP_CORE_TARGET_NAME}/types/char.h")
    set(STONEYDSP_CORE_TYPES_SCHAR_H_FILE "${STONEYDSP_INCLUDE_DIR}/${STONEYDSP_SLUG}/${STONEYDSP_CORE_TARGET_NAME}/types/schar.h")
    set(STONEYDSP_CORE_TYPES_UCHAR_H_FILE "${STONEYDSP_INCLUDE_DIR}/${STONEYDSP_SLUG}/${STONEYDSP_CORE_TARGET_NAME}/types/uchar.h")
    set(STONEYDSP_CORE_TYPES_SHRT_H_FILE "${STONEYDSP_INCLUDE_DIR}/${STONEYDSP_SLUG}/${STONEYDSP_CORE_TARGET_NAME}/types/shrt.h")
    set(STONEYDSP_CORE_TYPES_USHRT_H_FILE "${STONEYDSP_INCLUDE_DIR}/${STONEYDSP_SLUG}/${STONEYDSP_CORE_TARGET_NAME}/types/ushrt.h")
    ...
    set(STONEYDSP_CORE_TYPES_LONG_H_FILE "${STONEYDSP_INCLUDE_DIR}/${STONEYDSP_SLUG}/${STONEYDSP_CORE_TARGET_NAME}/types/long.h")
    set(STONEYDSP_CORE_TYPES_ULONG_H_FILE "${STONEYDSP_INCLUDE_DIR}/${STONEYDSP_SLUG}/${STONEYDSP_CORE_TARGET_NAME}/types/ulong.h")
    set(STONEYDSP_CORE_TYPES_LLONG_H_FILE "${STONEYDSP_INCLUDE_DIR}/${STONEYDSP_SLUG}/${STONEYDSP_CORE_TARGET_NAME}/types/llong.h")
    set(STONEYDSP_CORE_TYPES_ULLONG_H_FILE "${STONEYDSP_INCLUDE_DIR}/${STONEYDSP_SLUG}/${STONEYDSP_CORE_TARGET_NAME}/types/ullong.h")
    set(STONEYDSP_CORE_TYPES_DBL_H_FILE "${STONEYDSP_INCLUDE_DIR}/${STONEYDSP_SLUG}/${STONEYDSP_CORE_TARGET_NAME}/types/double.h")
    set(STONEYDSP_CORE_TYPES_LDBL_H_FILE "${STONEYDSP_INCLUDE_DIR}/${STONEYDSP_SLUG}/${STONEYDSP_CORE_TARGET_NAME}/types/ldouble.h")
    set(STONEYDSP_CORE_TYPES_FLT_H_FILE "${STONEYDSP_INCLUDE_DIR}/${STONEYDSP_SLUG}/${STONEYDSP_CORE_TARGET_NAME}/types/float.h")
    set(STONEYDSP_CORE_TYPES_BOOL_H_FILE "${STONEYDSP_INCLUDE_DIR}/${STONEYDSP_SLUG}/${STONEYDSP_CORE_TARGET_NAME}/types/bool.h")

    set(STONEYDSP_CORE_TYPES_INT8_H_FILE "${STONEYDSP_INCLUDE_DIR}/${STONEYDSP_SLUG}/${STONEYDSP_CORE_TARGET_NAME}/types/int8.h")
    set(STONEYDSP_CORE_TYPES_INT16_H_FILE "${STONEYDSP_INCLUDE_DIR}/${STONEYDSP_SLUG}/${STONEYDSP_CORE_TARGET_NAME}/types/int16.h")
    set(STONEYDSP_CORE_TYPES_INT32_H_FILE "${STONEYDSP_INCLUDE_DIR}/${STONEYDSP_SLUG}/${STONEYDSP_CORE_TARGET_NAME}/types/int32.h")
    set(STONEYDSP_CORE_TYPES_INT64_H_FILE "${STONEYDSP_INCLUDE_DIR}/${STONEYDSP_SLUG}/${STONEYDSP_CORE_TARGET_NAME}/types/int64.h")

    set(STONEYDSP_CORE_TYPES_UINT8_H_FILE "${STONEYDSP_INCLUDE_DIR}/${STONEYDSP_SLUG}/${STONEYDSP_CORE_TARGET_NAME}/types/uint8.h")
    set(STONEYDSP_CORE_TYPES_UINT16_H_FILE "${STONEYDSP_INCLUDE_DIR}/${STONEYDSP_SLUG}/${STONEYDSP_CORE_TARGET_NAME}/types/uint16.h")
    set(STONEYDSP_CORE_TYPES_UINT32_H_FILE "${STONEYDSP_INCLUDE_DIR}/${STONEYDSP_SLUG}/${STONEYDSP_CORE_TARGET_NAME}/types/uint32.h")
    set(STONEYDSP_CORE_TYPES_UINT64_H_FILE "${STONEYDSP_INCLUDE_DIR}/${STONEYDSP_SLUG}/${STONEYDSP_CORE_TARGET_NAME}/types/uint64.h")

    set(STONEYDSP_CORE_TYPES_PTRDIFF_H_FILE "${STONEYDSP_INCLUDE_DIR}/${STONEYDSP_SLUG}/${STONEYDSP_CORE_TARGET_NAME}/types/ptrdiff.h")
    set(STONEYDSP_CORE_TYPES_SIZE_H_FILE "${STONEYDSP_INCLUDE_DIR}/${STONEYDSP_SLUG}/${STONEYDSP_CORE_TARGET_NAME}/types/size.h")

    set(STONEYDSP_CORE_MATHS_CONSTANTS_H_FILE "${STONEYDSP_INCLUDE_DIR}/${STONEYDSP_SLUG}/${STONEYDSP_CORE_TARGET_NAME}/maths/constants.h")
    set(STONEYDSP_CORE_MATHS_CONVERSIONS_H_FILE "${STONEYDSP_INCLUDE_DIR}/${STONEYDSP_SLUG}/${STONEYDSP_CORE_TARGET_NAME}/maths/conversions.h")
    set(STONEYDSP_CORE_MATHS_FUNCTIONS_H_FILE "${STONEYDSP_INCLUDE_DIR}/${STONEYDSP_SLUG}/${STONEYDSP_CORE_TARGET_NAME}/maths/functions.h")
    set(STONEYDSP_CORE_MATHS_INTEGER_FUNCTIONS_H_FILE "${STONEYDSP_INCLUDE_DIR}/${STONEYDSP_SLUG}/${STONEYDSP_CORE_TARGET_NAME}/maths/integer_functions.h")
    ...
    list(APPEND STONEYDSP_CORE_HEADER_FILES
        ...
        "${STONEYDSP_CORE_TYPES_CHAR_H_FILE}"
        "${STONEYDSP_CORE_TYPES_SCHAR_H_FILE}"
        "${STONEYDSP_CORE_TYPES_UCHAR_H_FILE}"
        "${STONEYDSP_CORE_TYPES_SHRT_H_FILE}"
        "${STONEYDSP_CORE_TYPES_USHRT_H_FILE}"
        "${STONEYDSP_CORE_TYPES_INT_H_FILE}"
        "${STONEYDSP_CORE_TYPES_UINT_H_FILE}"
        "${STONEYDSP_CORE_TYPES_LONG_H_FILE}"
        "${STONEYDSP_CORE_TYPES_ULONG_H_FILE}"
        "${STONEYDSP_CORE_TYPES_LLONG_H_FILE}"
        "${STONEYDSP_CORE_TYPES_ULLONG_H_FILE}"
        "${STONEYDSP_CORE_TYPES_DBL_H_FILE}"
        "${STONEYDSP_CORE_TYPES_LDBL_H_FILE}"
        "${STONEYDSP_CORE_TYPES_FLT_H_FILE}"
        "${STONEYDSP_CORE_TYPES_BOOL_H_FILE}"
        "${STONEYDSP_CORE_TYPES_INT8_H_FILE}"
        "${STONEYDSP_CORE_TYPES_INT16_H_FILE}"
        "${STONEYDSP_CORE_TYPES_INT32_H_FILE}"
        "${STONEYDSP_CORE_TYPES_INT64_H_FILE}"
        "${STONEYDSP_CORE_TYPES_UINT8_H_FILE}"
        "${STONEYDSP_CORE_TYPES_UINT16_H_FILE}"
        "${STONEYDSP_CORE_TYPES_UINT32_H_FILE}"
        "${STONEYDSP_CORE_TYPES_UINT64_H_FILE}"
        "${STONEYDSP_CORE_TYPES_PTRDIFF_H_FILE}"
        "${STONEYDSP_CORE_TYPES_SIZE_H_FILE}"
        "${STONEYDSP_CORE_MATHS_CONSTANTS_H_FILE}"
        "${STONEYDSP_CORE_MATHS_CONVERSIONS_H_FILE}"
        "${STONEYDSP_CORE_MATHS_FUNCTIONS_H_FILE}"
        "${STONEYDSP_CORE_MATHS_INTEGER_FUNCTIONS_H_FILE}"
